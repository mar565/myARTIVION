...
    headerInstallBtn.innerHTML = '<span class="install-icon">✅</span><span class="install-text">Installed</span>';
    headerInstallBtn.title = 'App is already installed';
  }
...
        <ol>
          <li>Tap the menu (⋮) on the top right</li>
          <li>Select <code>Add to Home screen</code></li>
          <li>Confirm with <code>Add</code></li>
        </ol>
      `;
    } else {
      instructions = `
        <h4>Installation on Desktop:</h4>
        <ol>
          <li>Click the App icon (⊕) in the address bar</li>
          <li>Or: Menu → <code>Install app...</code></li>
          <li>Confirm with <code>Install</code></li>
        </ol>
      `;
    }
  } else if (browser.safari) {
    instructions = `
      <h4>Installation on iOS:</h4>
      <ol>
        <li>Tap the <strong>Share</strong> icon (□↑)</li>
        <li>Scroll down and select <code>Add to Home Screen</code></li>
        <li>Tap <code>Add</code></li>
      </ol>
    `;
...
      <ol>
        <li>Tap the menu (⋮) on the top right</li>
        <li>Select <code>Install</code> or <code>Add to Home screen</code></li>
...
    instructions = `
      <h4>Installation:</h4>
      <p>Please use Chrome, Edge, Safari, or Firefox for the best PWA support.</p>
    `;
  }
...
      <h3>📱 Install MyARTIVION</h3>
      <p>Install MyARTIVION as an app on your device for faster access and a native app experience.</p>
      <div class="pwa-install-steps">
        ${instructions}
      </div>
      <div class="pwa-install-buttons">
        <button class="btn-secondary" onclick="this.closest('.pwa-install-modal').remove()">Close</button>
      </div>
     </div>
  `;
...
      <p>Hello! I am your MyARTIVION Assistant. I can answer your questions about company policies, benefits, events, and more.</p>
    </div>
  `;
...
    {
      type: 'user',
      text: 'When is the Christmas party?',
      delay: 500
    },
    {
      type: 'bot',
      text: 'The 2025 Christmas party will take place on <strong>Friday, December 20, 2025</strong> at 6:00 PM.',
      link: {
        text: '🎄 To the event',
        section: 'news'
      },
...
    {
      type: 'user',
      text: 'Which benefits haven\'t I used yet?',
      delay: 2500
    },
    {
      type: 'bot',
      text: 'You haven\'t activated the following benefits yet:<br><br>• <strong>Motivational Car Leasing</strong> (2,800€/year)<br>• <strong>Corporate Benefits</strong> (600€/year)<br>• <strong>Summer Childcare</strong> (800€/year)<br><br>That\'s a total potential of 4,200€ per year!',
      link: {
        text: '💰 View benefits',
        section: 'benefits'
      },
